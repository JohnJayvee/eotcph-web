  ...
  <div class="card">
    <div class="card-body">
      ...
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" class="form-control" name="province_name" id="input_province_name" value="{{old('province_name')}}">
        <input type="hidden" class="form-control" name="city_name" id="input_city_name" value="{{old('city_name')}}">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="input_title">Region</label>
               {!!Form::select('region',[],old('region'),['id' => "input_region",'class' => "form-control ".($errors->first('region') ? 'border-red' : NULL)])!!}
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              {!!Form::select('province',[],old('province'),['id' => "input_province",'class' => "form-control ".($errors->first('city') ? 'border-red' : NULL)])!!}
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control {{$errors->first('obo_cluster') ? 'is-invalid' : NULL}}" id="input_obo_cluster" name="obo_cluster" placeholder="Obo cluster" value="{{old('obo_cluster')}}">
    ...
    $(function(){
      ...
      $("#input_province").on("change",function(){
        ...
        @if(strlen(old('region')) > 0)
          $(this).get_province("{{old('region')}}", "#input_province", "#input_city", "{{old('province')}}");
        @endif

        @if(strlen(old('province')) > 0)
          $(this).get_city("{{old('province')}}", "#input_city", "{{old('city')}}");
        @endif
