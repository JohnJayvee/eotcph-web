    ...
    border-bottom: 4px solid #254DA0;">
        <div class="container">
           <a class="navbar-brand" href="{{route('web.main.index')}}">
                <img src="{{asset('web/img/temp-logo.png')}}" alt="logo" class="img-fluid" width="30%" />
            </a>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse h-auto " id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto menu" >
                    ...
                    <li><a  href="{{route('system.auth.login')}}"><span class="badge badge-primary-2"><i class="fa fa-sign-in-alt"></i> Login</span></a></li>
